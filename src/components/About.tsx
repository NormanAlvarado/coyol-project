...
const About = () => {
  ...
  return (
    <section id="about" className="py-12 sm:py-16 lg:py-20 bg-navy">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-base sm:text-lg lg:text-xl font-noto text-cream/70 px-4">{t('about.subtitle')}</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="bg-gold/10 border-l-4 border-gold p-4 sm:p-6 rounded-r-lg">
              <p className="text-base sm:text-lg font-playfair italic text-gold">
