...
const TastingNotes = () => {
  ...
  return (
    <section id="tasting" className="py-12 sm:py-16 lg:py-20 bg-sophisticated">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-base sm:text-lg lg:text-xl font-noto text-cream/70 px-4">{t('tasting.subtitle')}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {notes.map((note, index) => (
            ...
            >
              <div className="bg-navy rounded-xl shadow-lg p-6 sm:p-8 h-full border border-gold/20 hover:shadow-2xl hover:shadow-gold/30 transition-all duration-300 hover:-translate-y-2">
                {/* Icon */}
                ...
                {/* Title */}
                <h3 className="text-xl sm:text-2xl font-playfair font-bold text-gold mb-3 sm:mb-4 text-center">
                  {note.title}
                </h3>

                {/* Description */}
                <p className="text-sm sm:text-base text-cream/70 font-noto text-center leading-relaxed">
                  {note.description}
                </p>
